...
echo "-----------------------------"
combineTool.py -M Impacts -d ${DATACARD} -m ${MASS} -t -1 --doInitialFit --robustFit 1 --rMin -10

echo "Second Stage: fit scan for each nuisance parameter"
echo "--------------------------------------------------"
combineTool.py -M Impacts -d ${DATACARD} -m ${MASS} -t -1 --robustFit 1 --doFits --parallel 7 --rMin -10

echo "Third Stage: collect outputs"
echo "----------------------------"
combineTool.py -M Impacts -d ${DATACARD} -m ${MASS} -t -1 -o impacts.json --rMin -10
